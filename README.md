...
| [11. Повышение качества работы с клиентами на основе ML] | На основе данных о посетителях сети фитнес-центров спрогнозирована вероятность оттока для каждого клиента, с помощью кластеризации составлены портреты пользователей, даны рекомендации по удержанию клиентов| *pandas*, *matplotlib*, *seaborn*, *sklearn*, *scipy* |